...
public class AviaSoulsTest {
    @Test  // выдача нескольких билетов через Comparable
    ...
    @Test  // выдача одного билета через Comparable
    public void ShouldSortOneOnPrice() {
        AviaSouls aviaSouls = new AviaSouls();
        Ticket ticket1 = new Ticket("SPb", "Msk", 600, 12, 14);
        Ticket ticket2 = new Ticket("SPb", "Msk", 300, 12, 14);
        Ticket ticket3 = new Ticket("Msk", "SPb", 500, 19, 21);
    ...
    @Test  // выдача пустого массива через Comparable
    public void ShouldSortZeroOnPrice() {
        AviaSouls aviaSouls = new AviaSouls();
        Ticket ticket1 = new Ticket("SPb", "Msk", 600, 12, 14);
        Ticket ticket2 = new Ticket("SPb", "Msk", 300, 12, 14);
        Ticket ticket3 = new Ticket("Msk", "SPb", 500, 19, 21);
        ...
        Ticket[] expected = { };
        Ticket[] actual = aviaSouls.search("SPb", "NY");

        Assertions.assertArrayEquals(expected, actual);
    }
    @Test  // выдача нескольких билетов через Comparator
    ...
    @Test  // выдача 1 билета через Comparator
    public void ShouldSortTimeWithComparatorOneTicket() {
        AviaSouls aviaSouls = new AviaSouls();
        Ticket ticket1 = new Ticket("SPb", "Msk", 600, 12, 14); // 2 ч., № 1
        Ticket ticket2 = new Ticket("SPb", "Msk", 300, 12, 17); // 5 № 3
        Ticket ticket3 = new Ticket("Msk", "SPb", 500, 19, 23); // 4
    ...
    @Test  // выдача пустого массива через Comparator
    public void ShouldSortTimeWithComparatorZeroTickets() {
        AviaSouls aviaSouls = new AviaSouls();
        Ticket ticket1 = new Ticket("SPb", "Msk", 600, 12, 14); // 2 ч., № 1
        Ticket ticket2 = new Ticket("SPb", "Msk", 300, 12, 17); // 5 № 3
        Ticket ticket3 = new Ticket("Msk", "SPb", 500, 19, 23); // 4
        ...
        Ticket[] expected = { };
        Ticket[] actual = aviaSouls.search("Msk", "NY", comparator);
